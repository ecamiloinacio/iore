 ...
 */
static void
period_certification (tinymt64_t * random)
{
 ...
 */
void
tinymt64_init (tinymt64_t * random, uint64_t seed)
{
 ...
 */
void
tinymt64_init_by_array (tinymt64_t * random, const uint64_t init_key[],
			int key_length)
{
  const int lag = 1;
  const int mid = 1;
